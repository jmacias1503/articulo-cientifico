...
\begin{table}[H]
   ...
   \begin{center}
      \begin{tabular}{p{3cm}|p{10cm}}
         ...
         Fuente & Conclusión\\
         \hline
         \textcite{ZAMMIT2023100035} & Utilizar la RV como una herramienta, mas no utilizarla totalmente\\
         \textcite{GUERRERO2022100002} & Implementar la RV como un nuevo sistema\\
         \textcite{SHIM2023100010} & La RV puede funcionar para conocimientos y habilidades especificas, pero no todas\\
         \hline
      \end{tabular}
   \end{center}
\end{table}
